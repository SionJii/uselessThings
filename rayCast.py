...
def draw_map():
    for row in range(8):
        for col in range(8):
            ...
            pygame.draw.rect(win, (200, 200, 200) if MAP[square] == '#' else
                             (100, 100, 100),
    ...
    for ray in range(CASTED_RAYS):
        for depth in range(MAX_DEPTH):
            ...
            if MAP[square] == '#':
                ...
                pygame.draw.line(win, (255, 255, 0), (player_x, player_y),
                                 (target_x, target_y))
                ...
                pygame.draw.rect(win, (color, color, color),
                                 (SCREEN_HEIGHT + ray * SCALE,
                                  (SCREEN_HEIGHT / 2) - wall_height / 2, SCALE,
                                  wall_height))
...
while True:
    ...
    pygame.draw.rect(win, (100, 0, 0),
                     (480, SCREEN_HEIGHT / 2, SCREEN_HEIGHT, SCREEN_HEIGHT))
